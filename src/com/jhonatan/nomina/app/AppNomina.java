...
public class AppNomina {
    public static void main(String[] args) {
        ...
        nom.agregarusuario(Juan);
        nom.agregarusuario(Julian);
        nom.agregarusuario(Carolina);
        nom.agregarusuario(David);
        nom.agregarusuario(Johanna);
        nom.agregarusuario(Gustavo);
        nom.agregarusuario(Pedro);
        nom.calcularNomina();
