...
public class guares {
    ...
    public void jugar() {
        ...
        if (validador == 0) {
            this.pote = 200;
            jugador.setPoteJugador(jugador.getPoteJugador() - 100);
            jugador.setPoteJugador(jugador.getPoteJugador() - 100);
            System.out.println(jugador.getPoteJugador());
            ...
            opcion = JOptionPane.showConfirmDialog(null,jugador.getNameJugador() +   " ,el pote actual es de "   + this.pote +" �Deseas lanzar el dado ",
        ...
        if (opcion == 0) {
            ...
            if(numero== 1)
            {
                JOptionPane.showConfirmDialog(null, jugador.getNameJugador()+ "Este es tu dado\n"
...
//} else
//	JOptionPane.showConfirmDialog(null,
//			"Sacaste un dado de valor " + this.dado + " con est� no puedes participar...\n Pasa el turno");
//
//turno++;
//}
//// jugador 2
